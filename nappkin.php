      ...
      <div class="reservePart">
          ...
          <div class="part_content" name="datum_content" id="datum_content">
              ...
              <table border="0" cellspacing="2" cellpadding="0">
                  <tr class="kvt">
                      <td colspan="1" class="mndSelect"><a href="#" name="maandprev" id="maandprev">&laquo;</a></td>
                      <td colspan="5" class="mndNaam" name="maandnaam" id="maandnaam">MAAND</td>
                      <td colspan="1" class="mndSelect"><a href="#" name="maandnext" id="maandnext">&raquo;</a></td>
                  </tr>
                  <tr class="kvh">
